              ...
              <div className="mx-auto max-w-2xl lg:max-w-5xl">
                <div className="max-w-2xl">
                  ...
                  <p className="mt-6 text-base text-zinc-400 ">
                    ...
                    Dhaka, Bangladesh. I focus on crafting innovative
                    technologies that enable ordinary people to navigate and use
                    the internet according to their preferences.
                  </p>
